...
const About = () => {
  return (
    <div className="w-full bg-white dark:bg-slate-900 overflow-hidden min-h-screen">
      ...
      <section className="relative px-6 pt-6 pb-12 text-center z-10">
        ...
        <p className="max-w-2xl mx-auto text-lg text-slate-600 dark:text-slate-400 font-medium leading-relaxed mb-12">
        ...
        <div className="max-w-5xl mx-auto rounded-3xl overflow-hidden shadow-2xl shadow-blue-500/20 dark:shadow-blue-900/40 border border-slate-200 dark:border-slate-700 relative group ring-4 ring-white/10 dark:ring-slate-800/50">
          <img 
      ...
      <section className="px-6 py-12 max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-slate-50 dark:bg-slate-800/50 p-8 rounded-3xl border border-slate-100 dark:border-slate-700/50 hover:border-blue-500/30 transition-colors group">
            <div className="w-12 h-12 bg-blue-100 dark:bg-blue-500/20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
      ...
      {/* Platform Features */}
      <section className="px-6 py-20 bg-blue-50/50 dark:bg-blue-950/10 mt-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-4">Comprehensive Platform Features</h2>
