    ...
    <footer className="relative bg-[#0B1120] text-slate-300 pt-12 pb-6 mt-auto overflow-hidden border-t border-slate-800/60">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 text-muted-500 order-1 md:order-2">
            ...
            <button 
              onClick={scrollToTop} 
              className="ml-4 p-2.5 bg-slate-800/80 hover:bg-gradient-to-tr hover:from-blue-600 hover:to-indigo-600 hover:text-white rounded-xl text-muted-400 border border-slate-700 hover:border-transparent transition-all duration-300 hover:-translate-y-1 hover:shadow-lg shadow-black/20"
              title="Back to Top"
            >
